...
namespace THREAD
{
    public partial class Form1 : Form
    {
        ...
        public void  clearscreen()//code for clearing screen
        {
            ...
            {
                boardLayout.DrawLine(layoutPen1, X, Y, X + this.m_width * this.m_NoOfCols, Y);
                Y = Y + m_Height;
            }
            ...
            {
                boardLayout.DrawLine(layoutPen1, X, Y, X, Y + this.m_Height * this.m_NoOfRows);
                X = X + this.m_width;
            }
        }
